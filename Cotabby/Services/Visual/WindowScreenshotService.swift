...
struct WindowScreenshotService: WindowScreenshotCapturing {
    ...
    func captureSnapshot(
        ...
        guard let display else {
            CotabbyLogger.app.debug("No shareable display found for window capture")
        ...
        CotabbyLogger.app.trace("Capturing full display \(display.width)x\(display.height) for window: \(windowTitle)")
