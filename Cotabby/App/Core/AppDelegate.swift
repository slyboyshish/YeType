...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        CotabbyLogger.app.info("YeType \(version) (build \(build)) launching on macOS \(ProcessInfo.processInfo.operatingSystemVersionString)")
    ...
    func applicationWillTerminate(_ notification: Notification) {
        ...
        CotabbyLogger.app.info("YeType terminating, releasing services")
