...
/// File overview:
/// Defines the small, semantic input-event vocabulary that the rest of YeType uses.
...
/// Normalized representation of the four modifier keys a YeType shortcut can require.
///
