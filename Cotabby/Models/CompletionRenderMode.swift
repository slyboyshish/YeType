...
/// drifts. Mirror mode sidesteps that by rendering the suggestion in a YeType-owned card anchored
...
nonisolated enum CompletionRenderMode: Equatable, Sendable {
    ...
    /// Suggestion drawn inside a YeType-owned card. Used when caret geometry is unreliable, or
