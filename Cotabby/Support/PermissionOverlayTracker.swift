...
/// macOS permission dialog, and YeType's own windows. Keeping the rule pure makes the no-op paths
/// cheap to test.
nonisolated enum PermissionOverlayTracker {
    ...
    ///     is not frontmost (e.g. the macOS permission dialog or YeType is in front).
