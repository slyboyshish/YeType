...
///
/// Foundation Models gives YeType an instructions channel, so these tests lock down which rules go
...
final class FoundationModelPromptRendererTests: XCTestCase {
    ...
    func test_sessionInstructions_omitTheUserName() {
        let request = YeTypeTestFixtures.suggestionRequest(userName: "UNIQUE_PROFILE_NAME")
