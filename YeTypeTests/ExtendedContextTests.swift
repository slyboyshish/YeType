...
final class ExtendedContextTests: XCTestCase {
    ...
    func test_buildRequest_collapsesWhitespaceOnlyExtendedContextToNil() {
        ...
        let settings = YeTypeTestFixtures.settingsSnapshot(extendedContext: "   \n\t  ")
    ...
    func test_buildRequest_stampsTrimmedExtendedContextOnRequest() {
        let context = YeTypeTestFixtures.focusedInputContext(precedingText: "Hello")
        let settings = YeTypeTestFixtures.settingsSnapshot(
    ...
    private func makeIsolatedDefaults() -> UserDefaults {
        let suiteName = "yetype.test.extendedContext.\(UUID().uuidString)"
