...
struct SuggestionSettingsStore {
    ...
    private static let isGloballyEnabledDefaultsKey = "yetypeGloballyEnabled"
    private static let disabledAppRulesDefaultsKey = "yetypeDisabledAppRules"
    private static let suggestInIntegratedTerminalsDefaultsKey = "yetypeSuggestInIntegratedTerminals"
    private static let showCaretIndicatorDefaultsKey = "yetypeShowCaretIndicator"
    private static let selectedIndicatorModeDefaultsKey = "yetypeSelectedIndicatorMode"
    private static let showAcceptanceHintDefaultsKey = "yetypeShowAcceptanceHint"
    private static let customSuggestionTextColorHexDefaultsKey = "yetypeCustomSuggestionTextColorHex"
    private static let ghostTextOpacityDefaultsKey = "yetypeGhostTextOpacity"
    private static let ghostTextSizeMultiplierDefaultsKey = "yetypeGhostTextSizeMultiplier"
    private static let selectedEngineDefaultsKey = "yetypeSelectedEngine"
    private static let selectedWordCountPresetDefaultsKey = "yetypeSelectedWordCountPreset"
    private static let usingCustomWordCountRangeDefaultsKey = "yetypeUsingCustomWordCountRange"
    private static let customWordCountLowWordsDefaultsKey = "yetypeCustomWordCountLowWords"
    private static let customWordCountHighWordsDefaultsKey = "yetypeCustomWordCountHighWords"
    ...
    private static let clipboardContextEnabledDefaultsKey = "yetypeClipboardContextEnabled"
    private static let fastModeEnabledDefaultsKey = "yetypeFastModeEnabled"
    private static let suppressCompletionsOnTypoDefaultsKey = "yetypeSuppressCompletionsOnTypo"
    private static let offerTypoCorrectionsDefaultsKey = "yetypeOfferTypoCorrections"
    private static let spellingDictionaryCodesDefaultsKey = "yetypeEnabledSpellingDictionaryCodes"
    private static let automaticallyFixTyposDefaultsKey = "yetypeAutomaticallyFixTypos"
    private static let performanceTrackingEnabledDefaultsKey = "yetypePerformanceTrackingEnabled"
    private static let menuBarWordCountVisibleDefaultsKey = "yetypeMenuBarWordCountVisible"
    private static let mirrorPreferenceDefaultsKey = "yetypeMirrorPreference"
    private static let userNameDefaultsKey = "yetypeUserName"
    private static let customRulesDefaultsKey = "yetypeCustomRules"
    private static let extendedContextDefaultsKey = "yetypeExtendedContext"
    private static let responseLanguagesDefaultsKey = "yetypeResponseLanguages"
    /// Legacy single-select key, read once to migrate the previous value into `responseLanguages`.
    private static let legacyResponseLanguageDefaultsKey = "yetypeResponseLanguage"
    private static let debounceMillisecondsDefaultsKey = "yetypeDebounceMilliseconds"
    private static let focusPollIntervalMillisecondsDefaultsKey = "yetypeFocusPollIntervalMilliseconds"
    private static let multiLineEnabledDefaultsKey = "yetypeMultiLineEnabled"
    private static let emojiPickerEnabledDefaultsKey = "yetypeEmojiPickerEnabled"
    private static let macroExpansionEnabledDefaultsKey = "yetypeMacroExpansionEnabled"
    private static let preferredEmojiSkinToneDefaultsKey = "yetypePreferredEmojiSkinTone"
    private static let preferredEmojiGenderDefaultsKey = "yetypePreferredEmojiGender"
    private static let autoAcceptTrailingPunctuationDefaultsKey = "yetypeAutoAcceptTrailingPunctuation"
    private static let acceptanceKeyCodeDefaultsKey = "yetypeAcceptanceKeyCode"
    private static let acceptanceKeyModifiersDefaultsKey = "yetypeAcceptanceKeyModifiers"
    private static let acceptanceKeyLabelDefaultsKey = "yetypeAcceptanceKeyLabel"
    private static let fullAcceptanceKeyCodeDefaultsKey = "yetypeFullAcceptanceKeyCode"
    private static let fullAcceptanceKeyModifiersDefaultsKey = "yetypeFullAcceptanceKeyModifiers"
    private static let fullAcceptanceKeyLabelDefaultsKey = "yetypeFullAcceptanceKeyLabel"
    private static let globalToggleKeyCodeDefaultsKey = "yetypeGlobalToggleKeyCode"
    private static let globalToggleKeyModifiersDefaultsKey = "yetypeGlobalToggleKeyModifiers"
    private static let globalToggleKeyLabelDefaultsKey = "yetypeGlobalToggleKeyLabel"
    private static let acceptanceGranularityDefaultsKey = "yetypeAcceptanceGranularity"

    private static let powerModelSwitchingEnabledDefaultsKey = "yetypePowerBasedModelSwitchingEnabled"
    private static let batteryEngineDefaultsKey = "yetypeBatteryEngine"
    private static let batteryModelFilenameDefaultsKey = "yetypeBatteryModelFilename"
    private static let pluggedInEngineDefaultsKey = "yetypePluggedInEngine"
    private static let pluggedInModelFilenameDefaultsKey = "yetypePluggedInModelFilename"
    ...
    func load(configuration: SuggestionConfiguration) -> SuggestionSettingsData {
        ...
        // Default ON, but the gate now distinguishes an in-progress correctly-spelled word (a valid
        // prefix of a real word — gray completion keeps flowing) from a genuine misspelling (green
        // correction). So a correct word still gets its continuation; only real errors swap to a
        // correction. See `isValidWordPrefix` in the suggestion coordinator.
        ...
        userDefaults.removeObject(forKey: "yetypeCustomIndicatorImageData")
