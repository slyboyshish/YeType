...
/// File overview:
/// Sanitizes auxiliary prompt context that YeType did not get from the focused text field itself.
///
...
enum PromptContextSanitizer {
    ...
    private static let knownWordSignals = [
        ...
        "code", "context", "yetype", "document", "email", "error", "field",
    ...
    private static func isLikelyShortMixedCaseNoise(_ token: String) -> Bool {
        ...
        // A single leading capital is normal prose ("Safari", "YeType"). Multiple capitals in
