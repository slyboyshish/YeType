...
/// File overview:
/// Centralizes YeType's permission metadata in one place.
///
...
nonisolated enum PermissionGuidanceStyle: Equatable, Sendable {
    /// Launch System Settings and show YeType's drag-and-drop helper overlay.
    case guidedOverlay
...
/// Describes one macOS privacy permission YeType can request.
///
...
enum YeTypePermissionKind: String, CaseIterable, Identifiable, Sendable {
    ...
    var guidanceHint: String {
        ...
        case .guidedOverlay:
            "YeType will open System Settings and show a drag helper anchored to the correct list."
        case .settingsOnly:
    ...
    /// Uses the same deep-link family YeType already shipped with.
    ///
