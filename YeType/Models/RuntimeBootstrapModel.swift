...
final class RuntimeBootstrapModel: ObservableObject {
    ...
    private static let selectedModelDefaultsKey = "yetypeSelectedModelFilename"
    ...
    func startIfNeeded() {
        ...
        runtimeTask = Task { [weak self] in
            ...
            do {
                ...
                YeTypeLogger.runtime.error("Runtime startup failed: \(error.localizedDescription)")
            }
        }
    }
    ...
    func selectModel(_ filename: String) async {
        ...
        runtimeTask = Task { [weak self] in
            ...
            do {
                ...
                YeTypeLogger.runtime.error("Runtime model switch failed: \(error.localizedDescription)")
            }
        }
