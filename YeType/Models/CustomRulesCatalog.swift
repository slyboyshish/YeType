...
/// File overview:
/// Defines YeType's custom autocomplete "rules" — short imperative style directives the user can
...
enum CustomRulesCatalog {
    ...
    /// fully reversible: stored rules in `yetypeCustomRules` are never deleted, the editor and
