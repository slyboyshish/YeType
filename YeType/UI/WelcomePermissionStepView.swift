...
///
/// The onboarding list is derived from `YeTypePermissionKind` (required cards from
...
struct WelcomePermissionStepView: View {
    ...
    private var requiredPermissions: [YeTypePermissionKind] {
        YeTypePermissionKind.allCases.filter(\.isRequiredForAutocomplete)
    }
    ...
    private var optionalPermissions: [YeTypePermissionKind] {
        YeTypePermissionKind.allCases.filter(\.isOptionalEnhancement)
    }
