...
struct WelcomeView: View {
    ...
    /// tuned YeType; advancing via "Set up later" preserves that.
    ...
    fileprivate var stepFooter: some View {
        ...
        case .aboutYou:
            WelcomeNavigation(
                ...
                disabledHint: "Add at least one language so YeType knows what to write in.",
...
extension WelcomeView {
    fileprivate var aboutYouStep: some View {
        VStack(spacing: 24) {
            VStack(spacing: 8) {
                Text("Tell YeType about yourself")
                    .font(.system(size: 24, weight: .semibold, design: .rounded))

                Text("Pick at least one language so YeType knows what to write in. Your name is optional.")
            ...
            VStack(alignment: .leading, spacing: 20) {
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    TextField("What should YeType call you?", text: Binding(
    ...
    fileprivate var doneStep: some View {
        VStack(spacing: 24) {
            ...
            HStack(spacing: 6) {
                ...
                Text("Find YeType in your menu bar.")
                    .font(.system(size: 13, weight: .medium, design: .rounded))
                    .foregroundStyle(.tertiary)
            }

            WelcomeButton(title: "Start Using YeType") {
                onDismiss()
            }
            .padding(.top, 4)
        }
