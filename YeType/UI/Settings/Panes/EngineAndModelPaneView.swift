...
struct EngineAndModelPaneView: View {
    ...
    /// read-only source; YeType's own folder is always scanned and is always the download target.
    ...
    var body: some View {
        ...
        .alert(
            ...
            Text("Remove \(model.displayName) from YeType's local models folder?")
        }
    }
                ...
                SettingsRowLabel(
                    ...
                    description: lmStudioModelsURL == nil
                        ...
                        : "Add models from your LM Studio library (~/.lmstudio/models) to the picker " +
                            "above. Downloads still save to YeType's own folder.",
