...
/// File overview:
/// Modal sheet listing the third-party packages YeType ships with. Lightweight by design: each
/// row names the project, summarizes what it does for YeType, and links to its repo. The intent
...
struct AcknowledgementsView: View {
    ...
    private static let entries: [AcknowledgementEntry] = [
        ...
        AcknowledgementEntry(
            name: "swift-log",
            summary: "Logging façade YeType uses across runtime, focus, and suggestion subsystems.",
        ...
        AcknowledgementEntry(
            name: "llama.cpp",
            summary: "High-performance local LLM inference engine that powers YeType's on-device suggestions.",
            url: "https://github.com/ggml-org/llama.cpp"
        )
    ]
}
