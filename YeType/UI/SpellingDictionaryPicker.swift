...
struct SpellingDictionaryPicker: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Text(
                "Choose which bundled dictionaries YeType may use for frequency-ranked corrections. "
                    + "With several enabled, YeType selects one from the surrounding text."
            )
            .font(.caption)
            ...
            Text(
                "Indexes load on demand and YeType keeps at most two in memory. If no bundled "
