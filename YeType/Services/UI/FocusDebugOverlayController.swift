...
/// Gated behind `-yetype-debug`. Shows focused-input geometry near the caret and renders a
...
final class FocusDebugOverlayController {
    static let launchArgument = YeTypeDebugOptions.launchArgument

    static var isEnabled: Bool {
        YeTypeDebugOptions.isEnabled
    }
    ...
    /// of truth for sensitive text debugging, and it is already gated behind `-yetype-debug`.
