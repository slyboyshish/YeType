...
final class PermissionOverlayWindowController: NSWindowController {
    ...
    init(
        ...
        permission: YeTypePermissionKind,
...
private final class PermissionOverlayContentView: NSView {
    ...
    private func setup(hostApp: PermissionHostApp, permission: YeTypePermissionKind) {
    ...
    private func title(hostApp: PermissionHostApp, permission: YeTypePermissionKind) -> NSAttributedString {
        NSAttributedString(
