...
/// completion. This is where raw generated text becomes a short suggestion YeType can safely show.
///
...
final class LlamaSuggestionEngine {
    ...
    func generateSuggestion(for request: SuggestionRequest) async throws -> SuggestionResult {
        ...
        do {
            ...
            YeTypeLogger.suggestion.debug("Llama generation cancelled", metadata: baseMetadata)
            ...
            YeTypeLogger.suggestion.debug("Llama generation cancelled (runtime task)", metadata: baseMetadata)
            throw SuggestionClientError.cancelled
