...
final class SuggestionEngineRouter {
    ...
    func generateSuggestion(for request: SuggestionRequest) async throws -> SuggestionResult {
        ...
        case .appleIntelligence:
            YeTypeLogger.suggestion.debug("Routing to Apple Intelligence engine", metadata: metadata)
            do {
        ...
        case .llamaOpenSource:
            YeTypeLogger.suggestion.debug("Routing to open-source llama engine", metadata: metadata)
...
final class UnavailableSuggestionEngine: SuggestionGenerating {
    ...
    func generateSuggestion(for request: SuggestionRequest) async throws -> SuggestionResult {
        YeTypeLogger.suggestion.warning("Engine unavailable: \(self.message)")
