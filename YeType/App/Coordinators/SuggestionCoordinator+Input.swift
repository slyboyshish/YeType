...
extension SuggestionCoordinator {
    ...
    func handlePermissionChange() {
        YeTypeLogger.suggestion.debug("Permission state changed, reconciling")
    ...
    /// like YeType swallowed the character.
    ///
    ...
    func handleSuppressedSyntheticInput() {
        logStage(
            ...
            message: "Ignored YeType's own synthetic key event."
        )
    }
