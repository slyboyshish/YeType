...
extension SuggestionCoordinator {
    ...
    /// snapshot or a user who resumed typing cannot make YeType delete an unrelated suffix.
    private func applyAutomaticCorrection(
        ...
        hideOverlay(reason: "Overlay hidden because YeType automatically fixed a typo.")
    ...
    func disablePredictions(reason: String) {
        YeTypeLogger.suggestion.debug("Predictions disabled: \(reason)")
        cancelPredictionWork()
